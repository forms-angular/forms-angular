...
if [ $1 ]; then
	if [ -d $BASE_DIR/../../$1 ]; then
	    ...
	    cp $BASE_DIR/../app/components/angular-route/angular-route.js $BASE_DIR/../../$1/app/lib/
	    cp $BASE_DIR/../app/components/angular-sanitize/angular-sanitize.js $BASE_DIR/../../$1/app/lib/
