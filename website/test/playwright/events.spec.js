...
test_1.test.describe("Events", function () {
    var width = 1024;
    var height = 768;
    ...
    (0, test_1.test)("should get an event from form input", function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var page = _b.page;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: 
                ...
                case 1:
                    // this tests the event handling on form input change
                    _c.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator("#cg_f_accepted")).toHaveCSS("background-color", "rgb(144, 238, 144)")];
                case 2:
                    _c.sent();
                    return [2 /*return*/];
            }
