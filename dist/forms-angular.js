...
(function (fng) {
    ...
    void (fng.formsAngular); // Make jshint happy
})(fng || (fng = {}));
/// <reference path="../../typings/angularjs/angular.d.ts" />
/// <reference path="../forms-angular.ts" />
var fng;
(function (fng) {
    fng.formsAngular.controller('BaseCtrl', [
        '$scope',
        '$rootScope',
        '$location',
        '$filter',
        ...
        'formGenerator',
        'recordHandler',
        function ($scope, $rootScope, $location, $filter, $modal, $window, $data, SchemasService, routingService, formGenerator, recordHandler) {
...
var fng;
(function (fng) {
    fng.formsAngular.controller('ModelCtrl', ['$scope', '$http', '$location', 'routingService', function ($scope, $http, $location, routingService) {
        $scope.models = [];
...
var fng;
(function (fng) {
    fng.formsAngular.controller('NavCtrl', ['$scope', '$data', '$location', '$filter', '$controller', 'routingService', 'cssFrameworkService', function ($scope, $data, $location, $filter, $controller, routingService, cssFrameworkService) {
        $scope.items = [];
...
var fng;
(function (fng) {
    fng.formsAngular.directive('modelControllerDropdown', function () {
        return {
            restrict: 'AE',
            replace: true,
...
var fng;
(function (fng) {
    fng.formsAngular.directive('errorDisplay', function () {
        return {
            restrict: 'E',
...
var fng;
(function (fng) {
    fng.formsAngular.directive('fngLink', function (routingService, SubmissionsService) {
        return {
            restrict: 'E',
            scope: { dataSrc: '&model' },
...
var fng;
(function (fng) {
    fng.formsAngular.directive('formButtons', ['cssFrameworkService', function (cssFrameworkService) {
        return {
            restrict: 'A',
...
(function (fng) {
    ...
    fng.formsAngular.directive('formInput', ['$compile', '$rootScope', '$filter', '$data', 'routingService', 'cssFrameworkService', 'formGenerator', 'formMarkupHelper', function ($compile, $rootScope, $filter, $data, routingService, cssFrameworkService, formGenerator, formMarkupHelper) {
        return {
            restrict: 'EA',
            link: function (scope, element, attrs) {
...
var fng;
(function (fng) {
    fng.formsAngular.controller('SearchCtrl', ['$scope', '$http', '$location', 'routingService', function ($scope, $http, $location, routingService) {
        var currentRequest = '';
        var _isNotMobile;
...
var fng;
(function (fng) {
    fng.formsAngular.filter('titleCase', [function () {
...
var fng;
(function (fng) {
    fng.formsAngular.service('addAllService', function () {
...
var fng;
(function (fng) {
    fng.formsAngular.provider('cssFrameworkService', [function () {
...
var fng;
(function (fng) {
    fng.formsAngular.factory('$data', [function () {
        var sharedData = {
...
var fng;
(function (fng) {
    fng.formsAngular.provider('routingService', ['$injector', '$locationProvider', function ($injector, $locationProvider) {
        var config = {
...
(function (fng) {
     ...
     *
     */
    fng.formsAngular.factory('formGenerator', function ($location, $timeout, SubmissionsService, routingService, recordHandler) {
...
var fng;
(function (fng) {
    fng.formsAngular.factory('formMarkupHelper', [
        'cssFrameworkService',
        'inputSizeHelper',
        'addAllService',
...
var fng;
(function (fng) {
    fng.formsAngular.factory('inputSizeHelper', [function () {
...
(function (fng) {
     ...
     */
    fng.formsAngular.factory('pluginHelper', ['formMarkupHelper', function (formMarkupHelper) {
        return {
...
(function (fng) {
     ...
     *
     */
    fng.formsAngular.factory('recordHandler', function ($location, $window, $filter, $timeout, routingService, SubmissionsService, SchemasService) {
...
var fng;
(function (fng) {
    fng.formsAngular.factory('SchemasService', ['$http', function ($http) {
        return {
...
var fng;
(function (fng) {
    fng.formsAngular.factory('SubmissionsService', ['$http', function ($http) {
        /*
